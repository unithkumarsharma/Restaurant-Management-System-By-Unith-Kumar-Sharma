...
lblTitle =Label(Tops, font=('arial',55,'bold'),text='Restaurant Management System',bd=21,bg='Cadet Blue',fg='white',justify=CENTER)
...
class funcdeclare:
    ...
    def Receipt(self):
        ...
        txtReceipt.insert(END, 'Cost of Dishes:\t\t\t\t' + CostofDishes.get() + '\nSubTotal:\t\t\t\t' + str(
            SubTotal.get()) + "\n")
...
Thumbsup=Checkbutton(Drinks_F, text='Thumbs Up', variable=var1, onvalue=1, offvalue=0, font=('arial',16,'bold')
                  ,bg= "Powder Blue", command=obj.chkThumbsup).grid(row=0,sticky=W)
Redbull=Checkbutton(Drinks_F, text='Red Bull', variable=var2, onvalue=1, offvalue=0, font=('arial',16,'bold')
                  ,bg= "Powder Blue", command=obj.chkRedbull).grid(row=1,sticky=W)
Sevenup=Checkbutton(Drinks_F, text='7 Up', variable=var3, onvalue=1, offvalue=0, font=('arial',16,'bold')
                  ,bg= "Powder Blue", command=obj.chkSevenup).grid(row=2,sticky=W)
Bira=Checkbutton(Drinks_F, text='Bira', variable=var4, onvalue=1, offvalue=0, font=('arial',16,'bold')
                  ,bg= "Powder Blue", command=obj.chkBira).grid(row=3,sticky=W)
Corona=Checkbutton(Drinks_F, text='Corona', variable=var5, onvalue=1, offvalue=0, font=('arial',16,'bold')
                  ,bg= "Powder Blue", command=obj.chkCorona).grid(row=4,sticky=W)
Budweiser=Checkbutton(Drinks_F, text='Budweiser', variable=var6, onvalue=1, offvalue=0, font=('arial',16,'bold')
                  ,bg= "Powder Blue", command=obj.chkBudweiser).grid(row=5,sticky=W)
Hoegaarden=Checkbutton(Drinks_F, text='Hoegaarden', variable=var7, onvalue=1, offvalue=0, font=('arial',16,'bold')
                  ,bg= "Powder Blue", command=obj.chkHoegaarden).grid(row=6,sticky=W)
Heineken=Checkbutton(Drinks_F, text='Heineken', variable=var8, onvalue=1, offvalue=0, font=('arial',16,'bold')
